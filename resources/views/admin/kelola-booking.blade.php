...
@section('conten')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <button type="button" class="btn btn-primary btn-xs btn-labeled btn-rounded"><b><i
                        class="icon-people"></i></b>Tambah</button>
        </div>
            ...
            <tbody>
                @foreach ($data as $datas)
                    <tr>
                        ...
                        <td>{{ $datas->nama }}</td>
                        <td>{{ $datas->lapangan }}</td>
                        <td>{{ $datas->tanggal }}</td>
                        <td>{{ $datas->jam }}</td>
                        <td>{{ $datas->durasi }}</td>
                        <td>{{ $datas->biaya }}</td>
                        <td>{{ $datas->bukti_bayar }}</td>
                        <td><span class="label label-success">{{ $datas->status }}</span></td>
                        <td>{{ $datas->alasan_pembatalan }}</td>
                        <td>
                            <ul class="icons-list">
                                <li class="text-primary-600" data-toggle="modal"data-target="#modal_form_horizontal"><a
